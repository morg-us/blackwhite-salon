...
export function AppointmentForm() {
  ...
  return (
    <section id="appointment" className="py-24 bg-card/50">
      <div className="container px-4 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Size en uygun zamanı seçerek hemen randevunuzu oluşturun.</p>
        </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="tel" placeholder="Örn: 05xx xxx xx xx" {...field} className="bg-background border-border" data-testid="input-phone" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="gulcan">Gülcan K. (Saç)</SelectItem>
                          <SelectItem value="buse">Buse T. (Makyaj)</SelectItem>
                          <SelectItem value="zeynep">Zeynep A. (Tırnak)</SelectItem>
              ...
              <div className="pt-4 flex justify-center">
                <Button 
                  ...
                  className="w-full md:w-auto min-w-[250px] bg-primary hover:bg-primary/90 text-primary-foreground"
